...
export default function Requests() {
    ...
    const getRequests = async () => {
        let options = {
            method: "get",
            url: url + "/hospitalizations/requests",
            headers: {
    ...
    const destroy = (id) => {
        axios({
            ...
            url: url + "/hospitalizations/requests/" + id,
            method: "delete",
            headers: {
                Accept: "Application/json",
                Authorization: "Bearer " + token,
                                    ...
                                    <table className="items-center w-full bg-transparent border-collapse">
                                        <thead>
                                            <tr>
                                                ...
                                                <th
                                                    className={
                                                        "rounded-tr px-4 align-middle border-b border-solid py-3 text-xs capitalize border-l-0 border-r-0 whitespace-nowrap font-semibold text-left bg-slate-50 text-slate-500 border-slate-100"
                                                    }
                                                >
                                                   Actions
                                                </th>
                                                        ...
                                                        <tr key={id}>
                                                            ...
                                                            <td className="border-t-0 px-4 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4 flex justify-around">
                                                                <Link
                                                                    ...
                                                                    onClick={() => {
                                                                        setHospitalization(request);
                                                                        showForm();
                                                                    }}
                                                                    className="hover:text-green-400 transition duration-150 ease-in-out "
                                                                >
