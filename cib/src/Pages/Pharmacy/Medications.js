                                    ...
                                    <table className="items-center w-full bg-transparent border-collapse">
                                        <thead>
                                            <tr>
                                                ...
                                                <th
                                                    className={
                                                        "rounded-tr px-4 align-middle border-b border-solid py-3 text-xs capitalize border-l-0 border-r-0  font-semibold text-left bg-slate-50 text-slate-500 border-slate-100 whitespace-nowrap"
                                                    }
                                                >
                                                    Add
                                                    <Link
                                                        className="!ml-4 text-slate-600   hover:text-green-500"
                                                        role={"button"}
                                                        onClick={() => {
                                                            showForm("add");
                                                        }}
                                                ...
                                                (medication, id) => {
                                                    return (
                                                        <tr key={id}>
                                                            ...
                                                            <td className="border-t-0 px-4 align-middle border-l-0 border-r-0 text-xs  p-4">
                                                                {
                                                                    medication.class_pharmacological
                                                                }
                                                            </td>
                                                            <td className="border-t-0 px-4 align-middle border-l-0 border-r-0 text-xs  p-4">
                                                                {
                                                                    medication.class_therapeutic
                                                                }
                                                            </td>
                                                            <td className="border-t-0 px-4 align-middle border-l-0 border-r-0 text-xs  p-4">
                                                                {
